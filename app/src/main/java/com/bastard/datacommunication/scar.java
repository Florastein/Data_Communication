...
public class scar extends AppCompatActivity {
	...
	private int[] correctAnswers = {2, 1, 2, 2, 1, 0, 1, 2, 2, 0, 1, 2, 0, 1, 1, 1, 2, 1, 3, 2, 2, 2, 1, 1, 0,2, 0, 1, 0, 1, 2, 3, 1, 2, 2, 2, 2, 1, 2, 3, 2, 2, 3, 1, 3, 1,2, 1, 2, 1,2, 2, 1 , 0, 0, 3, 0, 1, 3, 0, 1, 1, 1, 0, 3, 1, 0, 0, 2, 0, 2, 0, 2, 1, 2, 1, 2, 1, 2, 1, 1, 2, 3, 0, 1, 2, 3, 0, 2, 0, 0, 3, 2, 1, 2,2, 1, 0, 0, 0 , 1,1,3,1,0,0,2,2,3,2,3,1,2,2,1,0,0,1,0,2,1,3,0,0,2,1,3,3,1,2,3,0,0,3,2,3,0,1,1,3,2,2,1,3,1,3,0,2,1,3,0,0,0,1,3,0,2,1,1,0,3,2,2,2,3,3,3,1,3,3,0,0,1,2,1,1,3,2,0,2,1,1,0,1,1,0,2,1,1,1,2,2,1,2,0,3,1,0,1,0};
			...
			public void onClick(View view) {
				...
				if (selectedRadioButtonId != -1) {
					...
					if (selectedAnswerIndex == correctAnswers[currentQuestionIndex]) {
						Toast.makeText(scar.this, "Correct!", Toast.LENGTH_SHORT).show();
						currentQuestionIndex++;
					} else {
						Toast.makeText(scar.this, "Incorrect. Try again.", Toast.LENGTH_SHORT).show();
					}
					currentQuestionIndex++;
					...
					Toast.makeText(scar.this, "Please select an answer.", Toast.LENGTH_SHORT).show();
				}
			}
		});
